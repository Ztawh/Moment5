...
switch ($method) {
    ...
    case 'POST':
        ...
        if ($courseObj->addCourse($data->course_id, $data->name, $data->progression, $data->course_syllabus)) {
    ...
    case 'PUT':
        ...
        if (!isset($id)) {
            ...
            if ($courseObj->editCourse($id, $data->course_id, $data->name, $data->progression, $data->course_syllabus)) {
